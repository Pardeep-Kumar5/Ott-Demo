...
import sideBarImage1 from "../Images/sidebar-1.jpg";
import sideBarImage2 from "../Images/sidebar-2.jpg";
import sideBarImage3 from "../Images/sidebar-3.jpg";
import sideBarImage4 from "../Images/sidebar-4.jpg";
    ...
    <div className="fixed-plugin">
      <Dropdown>
        <Dropdown.Toggle
          ...
          variant=""
          className="text-dark border-0 opacity-100"
        >
          Hello
